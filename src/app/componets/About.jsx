...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-[#fdf4d7e0]">
      <section className="flex flex-col pb-25 pt-18 lg:flex-row items-center gap-12 px-8  max-w-7xl mx-auto">
        <div className="relative w-full md:h-[450px] h-[350px] lg:w-1/2">
          ...
          <div className="absolute bottom-0 left-0  bg-[#480200] text-white p-4 text-center">
            <p className="text-2xl font-bold">+106</p>
            <p className="text-sm tracking-wide">BIG SUITES ROOMS</p>
          </div>
        </div>
        <div className="w-full lg:w-1/2">
          <p className="uppercase tracking-wide text-sm text-[#2A1105] mb-2">Hotel Bayview</p>
          <h2 className="md:text-4xl text-2xl font-serif text-gray-900  leading-tight mb-6">Most Safe & Rated Hotel in Delhi</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-600 mb-6">
            <p className="text-[#2A1105]">At Vishwanath Hospitality Pvt. Ltd., we offer premium hospitality experiences with our collection of hotels conveniently located near the Delhi airport.</p>
          ...
          <div className="mt-8 flex items-center space-x-4">
            <div className="bg-[#480200]  text-white px-4 py-2 rounded shadow-lg text-sm font-semibold">
              Hurry up! It's the BEST PRICE!
            </div>
            <div className="relative bg-[#480200]    text-white w-18 h-18 flex items-center justify-center rounded-full shadow-xl">
              <span className="text-xl font-bold">&#8377; 1,999</span>
              <span className="absolute -top-2 -right-2 bg-[#2A1105] text-white text-xs px-1 rounded">NEW</span>
            </div>
          </div>
        </div>
      </section>
