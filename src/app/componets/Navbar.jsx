...
export default function Navbar() {
  ...
  <header className="fixed top-0 left-0 w-full z-50 bg-black/60 text-white py-4 px-6 flex justify-between items-center ">
    {/* Logo */}
  ...
  {/* Mobile Nav */}
  {isOpen && (
    <div className="md:hidden bg-black/70 pt-30 backdrop-blur-sm text-white px-6 py-4 space-y-4">
